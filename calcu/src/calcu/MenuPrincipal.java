...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		btnMatrices.setFont(new Font("Corbel", Font.PLAIN, 12));
        ...
        mat.setVisible(true);
				...
				btnSistEcuaciones.setFont(new Font("Corbel", Font.PLAIN, 12));
				...
				btnBasica.setFont(new Font("Corbel", Font.PLAIN, 12));
				...
				btnVectores.setFont(new Font("Corbel", Font.PLAIN, 12));
