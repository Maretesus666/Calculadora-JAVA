...
public class SistEcuaciones extends JFrame {
    ...
    public SistEcuaciones() {
        ...
        lblOpciones.setBounds(3, 26, 135, 23);
        ...
        lblSist2.setFont(new Font("BankGothic Lt BT", Font.PLAIN, 27));
        lblSist2.setBounds(156, 77, 211, 23);
        ...
        lblSist3.setFont(new Font("BankGothic Lt BT", Font.PLAIN, 27));
        lblSist3.setBounds(151, 168, 215, 23);
