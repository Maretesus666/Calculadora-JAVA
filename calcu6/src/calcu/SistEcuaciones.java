...
public class SistEcuaciones extends JFrame implements ActionListener{
    ...
    public SistEcuaciones() {
        ...
        lblResultado1.setForeground(new Color(31, 166, 140));
        ...
        textNum3.setForeground(Color.GRAY);
        ...
        textNum4.setForeground(Color.GRAY);
        ...
        textNum5.setForeground(Color.GRAY);
        ...
        textNum6.setForeground(Color.GRAY);
        ...
        textNum7.setForeground(Color.GRAY);
        ...
        textNum8.setForeground(Color.GRAY);
        ...
        textNum9.setForeground(Color.GRAY);
        ...
        textNum10.setForeground(Color.GRAY);
        ...
        textNum11.setForeground(Color.GRAY);
        ...
        textNum12.setForeground(Color.GRAY);
        ...
        lblResultado2.setForeground(new Color(31, 166, 140));
        ...
        lblResultado3.setForeground(new Color(31, 166, 140));
...
public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource() == btnSist2) {
        ...
        lblResultado3.setText(String.valueOf("..."));
